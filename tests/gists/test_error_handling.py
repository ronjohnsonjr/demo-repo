"""Error handling tests for gist endpoints.
...
def _mock_client(status_code: int) -> GitHubHTTPClient:
    ...
    mock_resp.headers = {}
    mock_resp.url = f"{BASE_URL}/gists/public"
...
class TestGistErrorHandling:
    """Error code tests for gist endpoints."""

    def test_bad_request_400(self):
        """Verify 400 for malformed gist requests.

        Setup: Mock client returning 400.
        Action: GET gist endpoint.
        ...
        # Action
        resp = client.get("/gists/public")

        # Assertions
        assert_status_code(resp, HTTP_400_BAD_REQUEST)

    def test_unauthorized_401(self):
        """Verify 401 for unauthenticated gist requests.
    ...
    def test_forbidden_403(self):
        """Verify 403 for accessing private gist content.
        ...
        # Action
        resp = client.get("/gists/private-gist-id")

        # Assertions
        assert_status_code(resp, HTTP_403_FORBIDDEN)

    def test_unprocessable_422(self):
        """Verify 422 for invalid gist creation payload.
    ...
    def test_rate_limited_429(self):
        """Verify 429 for rate-limited gist requests.
