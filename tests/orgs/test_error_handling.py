"""Error handling tests for organization endpoints.
...
def _mock_client(status_code: int) -> GitHubHTTPClient:
    ...
    mock_resp.headers = {}
    mock_resp.url = f"{BASE_URL}/orgs/github"
...
class TestOrgErrorHandling:
    """Error code tests for organization endpoints."""

    def test_bad_request_400(self):
        """Verify 400 for malformed organization requests.

        Setup: Mock client returning 400.
        Action: GET org endpoint.
        ...
        # Action
        resp = client.get(ENDPOINT_ORGS.format(org="github"))

        # Assertions
        assert_status_code(resp, HTTP_400_BAD_REQUEST)

    def test_unauthorized_401(self):
        """Verify 401 for unauthenticated requests to private org data.
        ...
        # Action
        resp = client.get("/orgs/github")

        # Assertions
        assert_status_code(resp, HTTP_401_UNAUTHORIZED)

    def test_forbidden_403(self):
        """Verify 403 for access to restricted org resources.

        Setup: Mock client returning 403.
        Action: GET org members endpoint.
        ...
        # Action
        resp = client.get("/orgs/private-org/members")

        # Assertions
        assert_status_code(resp, HTTP_403_FORBIDDEN)

    def test_unprocessable_422(self):
        """Verify 422 for org endpoints with invalid query parameters.
    ...
    def test_rate_limited_429(self):
        """Verify 429 for rate-limited org requests.
